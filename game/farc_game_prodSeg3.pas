...
begin
   ...
   if FCDdgEntities[ Entity ].E_colonies[ Colony ].C_reserveOxygen<>-1 then
   begin
      ...
      begin
         ...
         else FCDdgEntities[ Entity ].E_colonies[ Colony ].C_events[ ReturnedOverloadEvent ].CCSME_tOPOvPercentPopulationNotSupported:=PPS;
      ...
      begin
         ...
         begin
            ...
            begin
               ...
               if FCDdgEntities[ Entity ].E_colonies[ Colony ].C_events[ ReturnedShortageEvent ].CCSME_durationWeeks=-2
               then FCMgCSME_Event_Cancel(
                  csmeecImmediate
                  ,Entity
                  ,Colony
         ...
         begin
            ...
            if FCDdgEntities[ Entity ].E_colonies[ Colony ].C_events[ ReturnedShortageEvent ].CCSME_durationWeeks=-3 then
            begin
               if ( Entity=0 )
                  and ( Assigned( FCcps ) )
            ...
            else if FCDdgEntities[ Entity ].E_colonies[ Colony ].C_reserveOxygen>=FCDdgEntities[ Entity ].E_colonies[ Colony ].C_population.CP_total
            then FCMgCSME_Event_Cancel(
               csmeecRecover
               ,Entity
               ,Colony
            ...
            else if PPS<>FCDdgEntities[ Entity ].E_colonies[ Colony ].C_events[ ReturnedShortageEvent ].CCSME_tOShPercentPopulationNotSupportedAtCalculation
      ...
      if FCDdgEntities[ Entity ].E_colonies[ Colony ].C_reserveOxygen<FCDdgEntities[ Entity ].E_colonies[ Colony ].C_population.CP_total then
      begin
         ReturnedShortageEvent:=FCFgCSME_Search_ByType(
            ceOxygenShortage_Recovering
            ,Entity
         ...
         FCMgCR_Reserve_Update(
            ...
            ,Colony
            ,pfOxygen
            ,-FCDdgEntities[ Entity ].E_colonies[ Colony ].C_reserveOxygen
            ,true
            );
      end
      else if FCDdgEntities[ Entity ].E_colonies[ Colony ].C_reserveOxygen>=FCDdgEntities[ Entity ].E_colonies[ Colony ].C_population.CP_total
      then FCMgCR_Reserve_Update(
         ...
         ,Colony
         ,pfOxygen
         ,-FCDdgEntities[ Entity ].E_colonies[ Colony ].C_population.CP_total
         ,true
         );
   ...
   begin
      ...
      else FCDdgEntities[ Entity ].E_colonies[ Colony ].C_events[ ReturnedOverloadEvent ].CCSME_tWPOvPercentPopulationNotSupported:=PPS;
   end; //==END== else if ReturnedOverloadEvent>0 ==//
   ...
   begin
      ...
      begin
         ...
         else if FCDdgEntities[ Entity ].E_colonies[ Colony ].C_reserveWater>=FCDdgEntities[ Entity ].E_colonies[ Colony ].C_population.CP_total
         then FCMgCSME_Event_Cancel(
            csmeecRecover
            ,Entity
            ,Colony
         ...
         {.in any other case, do the over time process, if it's required}
         else if PPS<>FCDdgEntities[ Entity ].E_colonies[ Colony ].C_events[ ReturnedShortageEvent ].CCSME_tWShPercentPopulationNotSupportedAtCalculation
   ...
   if FCDdgEntities[ Entity ].E_colonies[ Colony ].C_reserveWater<FCDdgEntities[ Entity ].E_colonies[ Colony ].C_population.CP_total then
   begin
      ReturnedShortageEvent:=FCFgCSME_Search_ByType(
         ceWaterShortage_Recovering
         ,Entity
      ...
      FCMgCR_Reserve_Update(
         ...
         ,Colony
         ,pfWater
         ,-FCDdgEntities[ Entity ].E_colonies[ Colony ].C_reserveWater
         ,true
         );
   end
   else if FCDdgEntities[ Entity ].E_colonies[ Colony ].C_reserveWater>=FCDdgEntities[ Entity ].E_colonies[ Colony ].C_population.CP_total
   ...
   begin
      ...
      else FCDdgEntities[ Entity ].E_colonies[ Colony ].C_events[ ReturnedOverloadEvent ].CCSME_tFPOvPercentPopulationNotSupported:=PPS;
   end; //==END== else if ReturnedOverloadEvent>0 ==//
   ...
   begin
      ...
      begin
         ...
         else if FCDdgEntities[ Entity ].E_colonies[ Colony ].C_reserveFood>=FCDdgEntities[ Entity ].E_colonies[ Colony ].C_population.CP_total
         then FCMgCSME_Event_Cancel(
            csmeecRecover
            ,Entity
            ,Colony
         ...
         {.in any other case, do the over time process, if it's required}
         else if PPS<>FCDdgEntities[ Entity ].E_colonies[ Colony ].C_events[ ReturnedShortageEvent ].CCSME_tFShPercentPopulationNotSupportedAtCalculation
   ...
   if FCDdgEntities[ Entity ].E_colonies[ Colony ].C_reserveFood<FCDdgEntities[ Entity ].E_colonies[ Colony ].C_population.CP_total then
   begin
      ReturnedShortageEvent:=FCFgCSME_Search_ByType(
         ceFoodShortage_Recovering
         ,Entity
      ...
      FCMgCR_Reserve_Update(
         ...
         ,Colony
         ,pfFood
         ,-FCDdgEntities[ Entity ].E_colonies[ Colony ].C_reserveFood
         ,true
         );
   end
   else if FCDdgEntities[ Entity ].E_colonies[ Colony ].C_reserveFood>=FCDdgEntities[ Entity ].E_colonies[ Colony ].C_population.CP_total
