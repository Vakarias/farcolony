...
///</summary>
///   <param name="DistanceFromStar">distance of the orbital object for its star, in AU</param>
///   <param name="Angle">orbital object's current seasonal angle</param>
///   <returns>X, Y and Z in TFCRoglfPosition.</returns>
...
//   const
//   const Angle: extended ): TFCRoglfPosition;
