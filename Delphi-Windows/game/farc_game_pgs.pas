...
begin
   ...
   BRCpopAmedian:=FCentities[BRCfac].E_col[BRCcol].COL_population.POP_tpAmedian;
   BRCpopASmiSp:=FCentities[BRCfac].E_col[BRCcol].COL_population.POP_tpASmiSp;
   BRCpopASoff:=FCentities[BRCfac].E_col[BRCcol].COL_population.POP_tpASoff;
   BRCpopBSbio:=FCentities[BRCfac].E_col[BRCcol].COL_population.POP_tpBSbio;
   BRCpopBSdoc:=FCentities[BRCfac].E_col[BRCcol].COL_population.POP_tpBSdoc;
   BRCpopCol:=FCentities[BRCfac].E_col[BRCcol].COL_population.POP_tpColon;
   BRCpopESecof:=FCentities[BRCfac].E_col[BRCcol].COL_population.POP_tpESecof;
   BRCpopESecol:=FCentities[BRCfac].E_col[BRCcol].COL_population.POP_tpESecol;
   BRCpopISeng:=FCentities[BRCfac].E_col[BRCcol].COL_population.POP_tpISeng;
   BRCpopIStech:=FCentities[BRCfac].E_col[BRCcol].COL_population.POP_tpIStech;
   BRCpopMScomm:=FCentities[BRCfac].E_col[BRCcol].COL_population.POP_tpMScomm;
   BRCpopMSsold:=FCentities[BRCfac].E_col[BRCcol].COL_population.POP_tpMSsold;
   BRCpopPSastr:=FCentities[BRCfac].E_col[BRCcol].COL_population.POP_tpPSastr;
   BRCpopPSphys:=FCentities[BRCfac].E_col[BRCcol].COL_population.POP_tpPSphys;
   case BRCtension of
      1:
      begin
         case BRChealth of
   ...
   FCentities[BRCfac].E_col[BRCcol].COL_population.POP_bRate:=DecimalRound(BRCfinal, 4, 0.00001);
end;
...
begin
   ...
   DRCpopASmiSp:=FCentities[DRCfac].E_col[DRCcol].COL_population.POP_tpASmiSp;
   DRCpopASoff:=FCentities[DRCfac].E_col[DRCcol].COL_population.POP_tpASoff;
   DRCpopBSbio:=FCentities[DRCfac].E_col[DRCcol].COL_population.POP_tpBSbio;
   DRCpopBSdoc:=FCentities[DRCfac].E_col[DRCcol].COL_population.POP_tpBSdoc;
   DRCpopCol:=FCentities[DRCfac].E_col[DRCcol].COL_population.POP_tpColon;
   DRCpopESecof:=FCentities[DRCfac].E_col[DRCcol].COL_population.POP_tpESecof;
   DRCpopESecol:=FCentities[DRCfac].E_col[DRCcol].COL_population.POP_tpESecol;
   DRCpopISeng:=FCentities[DRCfac].E_col[DRCcol].COL_population.POP_tpISeng;
   DRCpopIStech:=FCentities[DRCfac].E_col[DRCcol].COL_population.POP_tpIStech;
   DRCpopMScomm:=FCentities[DRCfac].E_col[DRCcol].COL_population.POP_tpMScomm;
   DRCpopMSsold:=FCentities[DRCfac].E_col[DRCcol].COL_population.POP_tpMSsold;
   DRCpopPSastr:=FCentities[DRCfac].E_col[DRCcol].COL_population.POP_tpPSastr;
   DRCpopPSphys:=FCentities[DRCfac].E_col[DRCcol].COL_population.POP_tpPSphys;
   ...
   FCentities[DRCfac].E_col[DRCcol].COL_population.POP_dRate:=DecimalRound(DRCfinalDR, 4, 0.00001);
end;
...
begin
   MAUXmeanA
      :=FCentities[MAUXfac].E_col[MAUXcol].COL_population.POP_meanA
         -(
            (FCentities[MAUXfac].E_col[MAUXcol].COL_population.POP_meanA-MAUXsendMA)
            *(MAUXsendPop/FCentities[MAUXfac].E_col[MAUXcol].COL_population.POP_total)
            );
   FCentities[MAUXfac].E_col[MAUXcol].COL_population.POP_meanA:=DecimalRound(MAUXmeanA, 1, 0.01);
end;
