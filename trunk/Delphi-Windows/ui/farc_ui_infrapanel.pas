      ...
      begin
         ...
         begin
            ...
            then UIIPduration:=FCFgICS_BuildingDuration_Calculation(
               ...
               ,1
               ,UIIPiCWP
               ,FCDBsSys[AIScurrLocation.CLI_starsys].SS_star[AIScurrLocation.CLI_star].SDB_obobj[AIScurrLocation.CLI_oobj].OO_satList[AIScurrLocation.CLI_sat].OOS_regions[ FCentities[0].E_col[UIIPcolony].COL_settlements[UIIPcolony].CS_region ].OOR_emo
               );
