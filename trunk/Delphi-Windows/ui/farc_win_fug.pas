...
begin
   ...
   begin
      ...
      FCDBsSys[0].SS_star[1].SDB_class:=TFCEstarClass(FUGmStarClass.ItemIndex);
      ...
      begin
         ...
         FCDBsSys[0].SS_star[2].SDB_class:=TFCEstarClass(FUGcs1Class.ItemIndex);
         if FUGcs1Temp.Text=''
         ...
         begin
            ...
            FCDBsSys[0].SS_star[3].SDB_class:=TFCEstarClass(FUGcs2Class.ItemIndex);
            if FUGcs2Temp.Text=''
