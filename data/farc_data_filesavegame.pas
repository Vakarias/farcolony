   ...
   begin
      ...
      begin
         ...
         begin
            ...
            FCGtskListInProc[Count].T_inProcessData.TITP_timeOrg:=XMLSavedGameItem.Attributes['tipTimeOrg'];
...
begin
   ...
   begin
      ...
      begin
         ...
         XMLSavedGameItemSub.Attributes['tipTimeOrg']:=FCGtskListInProc[Count].T_inProcessData.TITP_timeOrg;
