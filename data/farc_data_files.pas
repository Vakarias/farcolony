...
begin
   ...
   begin
      ...
      begin
         ...
         isFundamentalResearch:=RDSnode.Attributes['fundamentalrsrch'];
         if not isFundamentalResearch then
         begin
            ...
            begin
               ...
               begin
                  ...
                  if Count3=-1
                  then raise Exception.Create( 'bad technoscience rts field: '+RDStechsciItem.Attributes['field'] );
               ...
               begin
                  ...
                  FCDdrdsResearchDatabase[EnumIndex].RD_researchFields[EnumIndex1].RF_technosciences[Count].TS_influenceProjections[Count2].IP_type:=TFCEdrdsInfluenceProjectionTypes( EnumIndex );
                  if EnumIndex=-1
            ...
            Count:=length( FCDdrdsResearchDatabase[EnumIndex].RD_fundamentalResearches );
            setlength( FCDdrdsResearchDatabase[EnumIndex].RD_fundamentalResearches, Count + 1 );


            FCDdrdsResearchDatabase[EnumIndex].RD_fundamentalResearches[Count].TS_token:=RDSnode.Attributes['token'];

            Count1:=GetEnumValue( TypeInfo( TFCEdrdsTechnologyLevels ), RDSnode.Attributes['techlevel'] );
            FCDdrdsResearchDatabase[EnumIndex].RD_fundamentalResearches[Count].TS_techLevel:=TFCEdrdsTechnologyLevels( Count1 );
            if Count1=-1
            then raise Exception.Create( 'bad fundamental research tech level: '+RDSnode.Attributes['techlevel'] );

            FCDdrdsResearchDatabase[EnumIndex].RD_fundamentalResearches[Count].TS_difficulty:=RDSnode.Attributes['difficulty'];
            FCDdrdsResearchDatabase[EnumIndex].RD_fundamentalResearches[Count].TS_discoveryThreshold:=RDSnode.Attributes['discothres'];
            FCDdrdsResearchDatabase[EnumIndex].RD_fundamentalResearches[Count].TS_maxRIPpoints:=RDSnode.Attributes['maxRIPpoints'];
            SetLength( FCDdrdsResearchDatabase[EnumIndex].RD_fundamentalResearches[Count].TS_relatedTechnosciences, 1 );
            SetLength( FCDdrdsResearchDatabase[EnumIndex].RD_fundamentalResearches[Count].TS_additionalRelatedItems, 1 );
            SetLength( FCDdrdsResearchDatabase[EnumIndex].RD_fundamentalResearches[Count].TS_influenceProjections, 1 );
            RDStechsciItem:=RDSnode.ChildNodes.First;
            Count1:=0;
            Count2:=0;
            Count4:=0;
            ...
            begin
               ...
               begin
                  ...
                  if Count3=-1
                  then raise Exception.Create( 'bad fundamental research rts field: '+RDStechsciItem.Attributes['field'] );
                  ...
                  FCDdrdsResearchDatabase[EnumIndex].RD_fundamentalResearches[Count].TS_relatedTechnosciences[Count1].RTS_rawInfluence:=RDStechsciItem.Attributes['maxRTSpoints'];
               end
               else if RDStechsciItem.NodeName = 'ari' then
               begin
                  inc( Count4 );
                  setlength( FCDdrdsResearchDatabase[EnumIndex].RD_fundamentalResearches[Count].TS_additionalRelatedItems, Count4 + 1 );

                  EnumIndex:=GetEnumValue( TypeInfo( TFCEdrdsARITypes ), RDStechsciItem.Attributes['type'] );
                  FCDdrdsResearchDatabase[EnumIndex].RD_fundamentalResearches[Count].TS_additionalRelatedItems[Count4].ARI_type:=TFCEdrdsARITypes( EnumIndex );
                  if EnumIndex=-1
               ...
               begin
                  ...
                  EnumIndex:=GetEnumValue( TypeInfo( TFCEdrdsInfluenceProjectionTypes ), RDStechsciItem.Attributes['type'] );
                  FCDdrdsResearchDatabase[EnumIndex].RD_fundamentalResearches[Count].TS_influenceProjections[Count2].IP_type:=TFCEdrdsInfluenceProjectionTypes( EnumIndex );
                  if EnumIndex=-1
...
begin
   ...
   begin
      ...
      begin
         ...
         EnumIndex:=GetEnumValue( TypeInfo( TFCEduHabitabilityIndex ), XMLStarSub.Attributes['habGravity'] );
         ...
         if EnumIndex=-1
         then raise Exception.Create( 'bad habitability (gravity): '+XMLStarSub.Attributes['habGravity'] );
         EnumIndex:=GetEnumValue( TypeInfo( TFCEduHabitabilityIndex ), XMLStarSub.Attributes['habRad'] );
         ...
         if EnumIndex=-1
         then raise Exception.Create( 'bad habitability (radiations): '+XMLStarSub.Attributes['habRad'] );
         EnumIndex:=GetEnumValue( TypeInfo( TFCEduHabitabilityIndex ), XMLStarSub.Attributes['habAtmosphere'] );
         ...
         if EnumIndex=-1
         then raise Exception.Create( 'bad habitability (atmosphere): '+XMLStarSub.Attributes['habAtmosphere'] );
         EnumIndex:=GetEnumValue( TypeInfo( TFCEduHabitabilityIndex ), XMLStarSub.Attributes['habAtmPressure'] );
         ...
         if EnumIndex=-1
         then raise Exception.Create( 'bad habitability (atmosphere pressure): '+XMLStarSub.Attributes['habAtmPressure'] );
         ...
         begin
            ...
            begin
               ...
               FCDduStarSystem[StarSystemCount].SS_stars[StarCount].S_orbitalObjects[OrbitalObjectCount].OO_isNotSat_axialTilt:=StrToFloat( XMLOrbitalObject.Attributes['inclinationAxis'], FCVdiFormat );
            ...
            begin
               ...
               EnumIndex:=GetEnumValue( TypeInfo( TFCEduAtmosphericGasStatus ), XMLOrbitalObject.Attributes['gasO2'] );
               ...
               if EnumIndex=-1
               then raise Exception.Create( 'bad universe orbital object atmospheric O2 gas status: '+XMLOrbitalObject.Attributes['gasO2'] );
               EnumIndex:=GetEnumValue( TypeInfo( TFCEduAtmosphericGasStatus ), XMLOrbitalObject.Attributes['gasH2S'] );
               ...
               if EnumIndex=-1
               then raise Exception.Create( 'bad universe orbital object atmospheric H2S gas status: '+XMLOrbitalObject.Attributes['gasH2S'] );
               EnumIndex:=GetEnumValue( TypeInfo( TFCEduAtmosphericGasStatus ), XMLOrbitalObject.Attributes['gasAr'] );
               ...
               if EnumIndex=-1
               then raise Exception.Create( 'bad universe orbital object atmospheric Ar gas status: '+XMLOrbitalObject.Attributes['gasAr'] );
               EnumIndex:=GetEnumValue( TypeInfo( TFCEduAtmosphericGasStatus ), XMLOrbitalObject.Attributes['gasCO2'] );
               ...
               if EnumIndex=-1
               then raise Exception.Create( 'bad universe orbital object atmospheric CO2 gas status: '+XMLOrbitalObject.Attributes['gasCO2'] );
               EnumIndex:=GetEnumValue( TypeInfo( TFCEduAtmosphericGasStatus ), XMLOrbitalObject.Attributes['gasNO2'] );
               ...
               if EnumIndex=-1
               then raise Exception.Create( 'bad universe orbital object atmospheric NO2 gas status: '+XMLOrbitalObject.Attributes['gasNO2'] );
               EnumIndex:=GetEnumValue( TypeInfo( TFCEduAtmosphericGasStatus ), XMLOrbitalObject.Attributes['gasO3'] );
               ...
               if EnumIndex=-1
               then raise Exception.Create( 'bad universe orbital object atmospheric O3 gas status: '+XMLOrbitalObject.Attributes['gasO3'] );
               EnumIndex:=GetEnumValue( TypeInfo( TFCEduAtmosphericGasStatus ), XMLOrbitalObject.Attributes['gasSO2'] );
               ...
               if EnumIndex=-1
               then raise Exception.Create( 'bad universe orbital object atmospheric SO2 gas status: '+XMLOrbitalObject.Attributes['gasSO2'] );
               EnumIndex:=GetEnumValue( TypeInfo( TFCEduHydrospheres ), XMLOrbitalObject.Attributes['hydrosphereType'] );
            ...
            begin
               ...
               begin
                  inc( Count1 );
                  EnumIndex:=GetEnumValue( TypeInfo( TFCEduOrbitalPeriodTypes ), XMLOObjSub1.Attributes['type'] );
                  ...
                  if EnumIndex=-1
                  then raise Exception.Create( 'bad orbital object - orbital period type: '+XMLOObjSub1.Attributes['type'] );
            ...
            begin
               ...
               begin
                  ...
                  FCDduStarSystem[StarSystemCount].SS_stars[StarCount].S_orbitalObjects[OrbitalObjectCount].OO_regions[Count1].OOR_seasonClosest.OP_windspeed:=XMLOObjSub1.Attributes['closeWindspd'];
                  ...
                  FCDduStarSystem[StarSystemCount].SS_stars[StarCount].S_orbitalObjects[OrbitalObjectCount].OO_regions[Count1].OOR_seasonIntermediate.OP_windspeed:=XMLOObjSub1.Attributes['intermWindspd'];
            ...
            begin
               ...
               begin
                  ...
                  begin
                     ...
                     FCDduStarSystem[StarSystemCount].SS_stars[StarCount].S_orbitalObjects[OrbitalObjectCount].OO_satellitesList[SatelliteCount].OO_gravitationalSphereRadius:=StrToFloat( XMSatellite.Attributes['gravSphereRadius'], FCVdiFormat );
                  ...
                  else if XMSatellite.NodeName='geophysicalData' then
                  begin
                     EnumIndex:=GetEnumValue( TypeInfo( TFCEduOrbitalObjectTypes ), XMSatellite.Attributes['type'] );
                     ...
                     if EnumIndex=-1
                     then raise Exception.Create( 'bad (sat) orbital object type: '+XMSatellite.Attributes['type'] );
                     FCDduStarSystem[StarSystemCount].SS_stars[StarCount].S_orbitalObjects[OrbitalObjectCount].OO_satellitesList[SatelliteCount].OO_diameter:=StrToFloat( XMSatellite.Attributes['diameter'], FCVdiFormat );
                     FCDduStarSystem[StarSystemCount].SS_stars[StarCount].S_orbitalObjects[OrbitalObjectCount].OO_satellitesList[SatelliteCount].OO_density:=XMSatellite.Attributes['density'];
                     FCDduStarSystem[StarSystemCount].SS_stars[StarCount].S_orbitalObjects[OrbitalObjectCount].OO_satellitesList[SatelliteCount].OO_mass:=StrToFloat( XMSatellite.Attributes['mass'], FCVdiFormat );
                     FCDduStarSystem[StarSystemCount].SS_stars[StarCount].S_orbitalObjects[OrbitalObjectCount].OO_satellitesList[SatelliteCount].OO_gravity:=StrToFloat( XMSatellite.Attributes['gravity'], FCVdiFormat );
                     ...
                     FCDduStarSystem[StarSystemCount].SS_stars[StarCount].S_orbitalObjects[OrbitalObjectCount].OO_satellitesList[SatelliteCount].OO_subsurfaceOcean:=XMSatellite.Attributes['subsurfOcean'];
                  ...
                  begin
                     ...
                     begin
                        ...
                        if EnumIndex=-1
                        then raise Exception.Create( 'bad satellite - orbital period type: '+XMLOObjSub1.Attributes['type'] );
                  ...
                  begin
                     ...
                     begin
                        ...
                        FCDduStarSystem[StarSystemCount].SS_stars[StarCount].S_orbitalObjects[OrbitalObjectCount].OO_satellitesList[SatelliteCount].OO_regions[Count1].OOR_seasonClosest.OP_windspeed:=XMLOObjSub1.Attributes['closeWindspd'];
                        ...
                        FCDduStarSystem[StarSystemCount].SS_stars[StarCount].S_orbitalObjects[OrbitalObjectCount].OO_satellitesList[SatelliteCount].OO_regions[Count1].OOR_seasonIntermediate.OP_windspeed:=XMLOObjSub1.Attributes['intermWindspd'];
                        ...
                        FCDduStarSystem[StarSystemCount].SS_stars[StarCount].S_orbitalObjects[OrbitalObjectCount].OO_satellitesList[SatelliteCount].OO_regions[Count1].OOR_seasonFarthest.OP_windspeed:=XMLOObjSub1.Attributes['farthWindspd'];
