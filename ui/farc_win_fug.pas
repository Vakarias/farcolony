...
type
   TFCWinFUG = class(TForm)
    ...
    CR_ObjToken: TLabeledEdit;
    CR_SurfTempMean: THTMLabel;
    CR_RegionLandType: THTMLabel;
   ...
   begin
      ...
      begin
         ...
         then break
            ...
            begin
               WF_XMLOutput.Lines.Add(
                  '      <orbobj token="'+FCDduStarSystem[0].SS_stars[Count].S_orbitalObjects[Count1].OO_dbTokenId
                     +'" ftSeed="'+FCDduStarSystem[0].SS_stars[Count].S_orbitalObjects[Count1].OO_fug_WorldSeed
                     +'" lightcolor="'+FCDduStarSystem[0].SS_stars[Count].S_orbitalObjects[Count1].OO_fug_Worldlightcolorfile
                     +'" climatefile="'+FCDduStarSystem[0].SS_stars[Count].S_orbitalObjects[Count1].OO_fug_Worldclimatefile
                     +'" habGravity="'+GetEnumName( TypeInfo( TFCEduHabitabilityIndex ), Integer( FCDduStarSystem[0].SS_stars[Count].S_orbitalObjects[Count1].OO_habitabilityGravity ) )
                     +'" habRad="'+GetEnumName( TypeInfo( TFCEduHabitabilityIndex ), Integer( FCDduStarSystem[0].SS_stars[Count].S_orbitalObjects[Count1].OO_habitabilityRadiations ) )
                     +'" habAtmosphere="'+GetEnumName( TypeInfo( TFCEduHabitabilityIndex ), Integer( FCDduStarSystem[0].SS_stars[Count].S_orbitalObjects[Count1].OO_habitabilityAtmosphere ) )
                     +'" habAtmPressure="'+GetEnumName( TypeInfo( TFCEduHabitabilityIndex ), Integer( FCDduStarSystem[0].SS_stars[Count].S_orbitalObjects[Count1].OO_habitabilityAtmPressure ) )
                     +'">'
                  );
               WF_XMLOutput.Lines.Add(
               ...
               WF_XMLOutput.Lines.Add(
                  '         <geophysicalData type="'+GetEnumName( TypeInfo( TFCEduOrbitalObjectTypes ), Integer( FCDduStarSystem[0].SS_stars[Count].S_orbitalObjects[Count1].OO_type ) )
                     ...
                     +'" subsurfOcean="'+BoolToStr( FCDduStarSystem[0].SS_stars[Count].S_orbitalObjects[Count1].OO_subsurfaceOcean, true )
                     +'"/>'
                  );
               WF_XMLOutput.Lines.Add(
                  '         <ecosphereData envType="'+GetEnumName( TypeInfo( TFCEduEnvironmentTypes ), Integer( FCDduStarSystem[0].SS_stars[Count].S_orbitalObjects[Count1].OO_environment ) )
                     ...
                     +'" traceAtmosphere="'+BoolToStr( FCDduStarSystem[0].SS_stars[Count].S_orbitalObjects[Count1].OO_atmosphere.AC_traceAtmosphere, true )
               ...
               begin
                  ...
                  begin
                     WF_XMLOutput.Lines.Add(
                        ...
                        +'" intermTemp="'+floattostr( FCDduStarSystem[0].SS_stars[Count].S_orbitalObjects[Count1].OO_regions[Count3].OOR_seasonIntermediate.OP_meanTemperature )
                        +'" intermWindspd="'+inttostr( FCDduStarSystem[0].SS_stars[Count].S_orbitalObjects[Count1].OO_regions[Count3].OOR_seasonIntermediate.OP_windspeed )
                        +'" intermRain="'+inttostr( FCDduStarSystem[0].SS_stars[Count].S_orbitalObjects[Count1].OO_regions[Count3].OOR_seasonIntermediate.OP_rainfall )
                        +'" farthTemp="'+floattostr( FCDduStarSystem[0].SS_stars[Count].S_orbitalObjects[Count1].OO_regions[Count3].OOR_seasonFarthest.OP_meanTemperature )
                        +'" farthWindspd="'+inttostr( FCDduStarSystem[0].SS_stars[Count].S_orbitalObjects[Count1].OO_regions[Count3].OOR_seasonFarthest.OP_windspeed )
                        +'" farthRain="'+inttostr( FCDduStarSystem[0].SS_stars[Count].S_orbitalObjects[Count1].OO_regions[Count3].OOR_seasonFarthest.OP_rainfall )
               ...
               begin
                  WF_XMLOutput.Lines.Add(
                     '         <satobj token="'+FCDduStarSystem[0].SS_stars[Count].S_orbitalObjects[Count1].OO_satellitesList[Count2].OO_dbTokenId
                        +'" ftSeed="'+FCDduStarSystem[0].SS_stars[Count].S_orbitalObjects[Count1].OO_satellitesList[Count2].OO_fug_WorldSeed
                        +'" lightcolor="'+FCDduStarSystem[0].SS_stars[Count].S_orbitalObjects[Count1].OO_satellitesList[Count2].OO_fug_Worldlightcolorfile
                        +'" climatefile="'+FCDduStarSystem[0].SS_stars[Count].S_orbitalObjects[Count1].OO_satellitesList[Count2].OO_fug_Worldclimatefile
                        +'" habGravity="'+GetEnumName( TypeInfo( TFCEduHabitabilityIndex ), Integer( FCDduStarSystem[0].SS_stars[Count].S_orbitalObjects[Count1].OO_satellitesList[Count2].OO_habitabilityGravity ) )
                        +'" habRad="'+GetEnumName( TypeInfo( TFCEduHabitabilityIndex ), Integer( FCDduStarSystem[0].SS_stars[Count].S_orbitalObjects[Count1].OO_satellitesList[Count2].OO_habitabilityRadiations ) )
                        +'" habAtmosphere="'+GetEnumName( TypeInfo( TFCEduHabitabilityIndex ), Integer( FCDduStarSystem[0].SS_stars[Count].S_orbitalObjects[Count1].OO_satellitesList[Count2].OO_habitabilityAtmosphere ) )
                        +'" habAtmPressure="'+GetEnumName( TypeInfo( TFCEduHabitabilityIndex ), Integer( FCDduStarSystem[0].SS_stars[Count].S_orbitalObjects[Count1].OO_satellitesList[Count2].OO_habitabilityAtmPressure ) )
                        +'">'
                     );
                  WF_XMLOutput.Lines.Add(
                  ...
                  then WF_XMLOutput.Lines.Add(
                     '            <geophysicalData type="'+GetEnumName( TypeInfo( TFCEduOrbitalObjectTypes ), Integer( FCDduStarSystem[0].SS_stars[Count].S_orbitalObjects[Count1].OO_satellitesList[Count2].OO_type ) )
                        ...
                        +'" subsurfOcean="'+BoolToStr( FCDduStarSystem[0].SS_stars[Count].S_orbitalObjects[Count1].OO_satellitesList[Count2].OO_subsurfaceOcean, true )
                        +'"/>'
                     )
                     ...
                     '            <geophysicalData type="'+GetEnumName( TypeInfo( TFCEduOrbitalObjectTypes ), Integer( FCDduStarSystem[0].SS_stars[Count].S_orbitalObjects[Count1].OO_satellitesList[Count2].OO_type ) )
                        ...
                        +'" gravity="'+floattostr( FCDduStarSystem[0].SS_stars[Count].S_orbitalObjects[Count1].OO_satellitesList[Count2].OO_gravity )
                        +'" escapeVel="'+floattostr( FCDduStarSystem[0].SS_stars[Count].S_orbitalObjects[Count1].OO_satellitesList[Count2].OO_escapeVelocity )
                        +'" rotationPeriod="'+floattostr( FCDduStarSystem[0].SS_stars[Count].S_orbitalObjects[Count1].OO_satellitesList[Count2].OO_isSat_asterInBelt_rotationPeriod )
                        +'" inclinationAxis="'+floattostr( FCDduStarSystem[0].SS_stars[Count].S_orbitalObjects[Count1].OO_satellitesList[Count2].OO_isSat_asterInBelt_axialTilt )
                        +'" magneticField="'+floattostr( FCDduStarSystem[0].SS_stars[Count].S_orbitalObjects[Count1].OO_satellitesList[Count2].OO_magneticField )
                        +'" tectonicActivity="'+GetEnumName( TypeInfo( TFCEduTectonicActivity ), Integer( FCDduStarSystem[0].SS_stars[Count].S_orbitalObjects[Count1].OO_satellitesList[Count2].OO_tectonicActivity ) )
                        +'" subsurfOcean="'+BoolToStr( FCDduStarSystem[0].SS_stars[Count].S_orbitalObjects[Count1].OO_satellitesList[Count2].OO_subsurfaceOcean, true )
                        +'"/>'
                  ...
                  WF_XMLOutput.Lines.Add(
                     '            <ecosphereData envType="'+GetEnumName( TypeInfo( TFCEduEnvironmentTypes ), Integer( FCDduStarSystem[0].SS_stars[Count].S_orbitalObjects[Count1].OO_satellitesList[Count2].OO_environment ) )
                        ...
                        +'" traceAtmosphere="'+BoolToStr( FCDduStarSystem[0].SS_stars[Count].S_orbitalObjects[Count1].OO_satellitesList[Count2].OO_atmosphere.AC_traceAtmosphere, true )
                  ...
                  begin
                     ...
                     begin
                        WF_XMLOutput.Lines.Add(
                           ...
                           +'" intermTemp="'+floattostr( FCDduStarSystem[0].SS_stars[Count].S_orbitalObjects[Count1].OO_satellitesList[Count2].OO_regions[Count3].OOR_seasonIntermediate.OP_meanTemperature )
                           +'" intermWindspd="'+inttostr( FCDduStarSystem[0].SS_stars[Count].S_orbitalObjects[Count1].OO_satellitesList[Count2].OO_regions[Count3].OOR_seasonIntermediate.OP_windspeed )
                           +'" intermRain="'+inttostr( FCDduStarSystem[0].SS_stars[Count].S_orbitalObjects[Count1].OO_satellitesList[Count2].OO_regions[Count3].OOR_seasonIntermediate.OP_rainfall )
                           +'" farthTemp="'+floattostr( FCDduStarSystem[0].SS_stars[Count].S_orbitalObjects[Count1].OO_satellitesList[Count2].OO_regions[Count3].OOR_seasonFarthest.OP_meanTemperature )
                           +'" farthWindspd="'+inttostr( FCDduStarSystem[0].SS_stars[Count].S_orbitalObjects[Count1].OO_satellitesList[Count2].OO_regions[Count3].OOR_seasonFarthest.OP_windspeed )
                           +'" farthRain="'+inttostr( FCDduStarSystem[0].SS_stars[Count].S_orbitalObjects[Count1].OO_satellitesList[Count2].OO_regions[Count3].OOR_seasonFarthest.OP_rainfall )
...
begin
   SSSG_StellarSysToken.Text:='stelsysEpsilonErid';
   SSSG_LocationX.Text:='6.21';
   SSSG_LocationY.Text:='8.31';
   SSSG_LocationZ.Text:='-1.56';
   TMS_StarToken.Text:='starEpsilonEri';
   TMS_StarClass.ItemIndex:=114;
   TMS_StarTemp.Text:='5084';
   TMS_StarMass.Text:='0.82';
   TMS_StarDiam.Text:='0.735';
   TMS_StarLum.Text:='0.34';
   TMS_OrbitGeneration.ItemIndex:=2;
   TMS_OrbitGenerationNumberOrbits.Text:='8';
   ...
   FCDfdMainStarObjectsList[1].OO_fug_BasicType:=oobtAsteroid;
   FCDfdMainStarObjectsList[1].OO_isSatellite:=false;
   FCDfdMainStarObjectsList[1].OO_isNotSat_distanceFromStar:=0.26;
   FCDfdMainStarObjectsList[1].OO_isNotSat_rotationPeriod:=-1272.13;
   FCDfdMainStarObjectsList[1].OO_isNotSat_axialTilt:=95.7;
   FCDfdMainStarObjectsList[1].OO_diameter:=1285.5;
   FCDfdMainStarObjectsList[1].OO_density:=3530;

   FCDfdMainStarObjectsList[2].OO_fug_BasicType:=oobtTelluricPlanet;
   FCDfdMainStarObjectsList[2].OO_isSatellite:=false;
   FCDfdMainStarObjectsList[2].OO_isNotSat_distanceFromStar:=0.49;
   FCDfdMainStarObjectsList[2].OO_isNotSat_rotationPeriod:=29.23;
   FCDfdMainStarObjectsList[2].OO_isNotSat_axialTilt:=17.3;
   FCDfdMainStarObjectsList[2].OO_diameter:=10326.2;
   FCDfdMainStarObjectsList[2].OO_density:=8247;

   FCDfdMainStarObjectsList[3].OO_fug_BasicType:=oobtTelluricPlanet;
   FCDfdMainStarObjectsList[3].OO_isSatellite:=false;
   FCDfdMainStarObjectsList[3].OO_isNotSat_distanceFromStar:=1.19;
   FCDfdMainStarObjectsList[3].OO_isNotSat_rotationPeriod:=19.29;
   FCDfdMainStarObjectsList[3].OO_isNotSat_axialTilt:=44.2;
   FCDfdMainStarObjectsList[3].OO_diameter:=13911.5;
   FCDfdMainStarObjectsList[3].OO_density:=3392;
   FCDfdMainStarObjectsList[3].OO_tectonicActivity:=taPlastic;
   FCDfdMainStarObjectsList[3].OO_atmosphericPressure:=791.309;
   FCDfdMainStarObjectsList[3].OO_atmosphere.AC_traceAtmosphere:=false;
   FCDfdMainStarObjectsList[3].OO_atmosphere.AC_primaryGasVolumePerc:=86;
   FCDfdMainStarObjectsList[3].OO_atmosphere.AC_gasPresenceH2:=agsTrace;
   FCDfdMainStarObjectsList[3].OO_atmosphere.AC_gasPresenceHe:=agsTrace;
   FCDfdMainStarObjectsList[3].OO_atmosphere.AC_gasPresenceCH4:=agsTrace;
   FCDfdMainStarObjectsList[3].OO_atmosphere.AC_gasPresenceNH3:=agsTrace;
   FCDfdMainStarObjectsList[3].OO_atmosphere.AC_gasPresenceH2O:=agsSecondary;
   FCDfdMainStarObjectsList[3].OO_atmosphere.AC_gasPresenceNe:=agsSecondary;
   FCDfdMainStarObjectsList[3].OO_atmosphere.AC_gasPresenceN2:=agsPrimary;
   FCDfdMainStarObjectsList[3].OO_atmosphere.AC_gasPresenceCO:=agsTrace;
   FCDfdMainStarObjectsList[3].OO_atmosphere.AC_gasPresenceNO:=agsSecondary;
   FCDfdMainStarObjectsList[3].OO_atmosphere.AC_gasPresenceO2:=agsSecondary;
   FCDfdMainStarObjectsList[3].OO_atmosphere.AC_gasPresenceH2S:=agsSecondary;
   FCDfdMainStarObjectsList[3].OO_atmosphere.AC_gasPresenceAr:=agsSecondary;
//   COO_Distance.Text:='1';
