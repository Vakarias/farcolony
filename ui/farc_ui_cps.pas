...
//   FCWinMain.FCWM_MainMenu.Items.Visible:=false;
   ...
   if ( FCVdgPlayer.P_economicStatus=pfs0_NotViable )
      xor ( FCVdgPlayer.P_socialStatus=pfs0_NotViable )
      xor ( FCVdgPlayer.P_militaryStatus=pfs0_NotViable )
   then FCWinMain.FCWM_CPSRSIGreport.HTMLText.Add( 'Your colony didnt achieved to be viable on long term')
      ...
      and ( FCVdgPlayer.P_socialStatus=pfs3_Independent )
      and ( FCVdgPlayer.P_militaryStatus=pfs3_Independent )
